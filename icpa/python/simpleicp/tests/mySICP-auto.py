...
if plot_results:
    ...
    ax.scatter(
        X_mov_2[idx_points_mov_2, 0],
        X_mov_2[idx_points_mov_2, 1],
        X_mov_2[idx_points_mov_2, 2],
        c="b",
        marker=".",
    )
    ax.scatter(
        X_mov_transformed_2[idx_points_mov_2, 0],
        X_mov_transformed_2[idx_points_mov_2, 1],
        X_mov_transformed_2[idx_points_mov_2, 2],
        c="b",
        marker=".",
    )
    ax.set_xlabel("x")
    ...
    file_path = os.path.join(output_directory, 'plot.png')
